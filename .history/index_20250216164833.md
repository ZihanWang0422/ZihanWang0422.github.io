...
<div>
    <div style="display: flex; align-items: center;">
        ...
        <div style="padding-left: 4%; width: 83%; display: inline-block;">
            ...
            <span style="font-size: 15px;">Topic: </span><span style="font-size: 15px; font-weight: bold">Visual Language Based 6-Dof Grasp</span>
        </div>
    </div>
    <br>
    <div style="display: flex; align-items: center;">
        ...
        <div style="padding-left: 4%; width: 83%; display: inline-block;">
            <span>
                ...
                <span style="font-size: 15px; float: right">June. 2023 - Jun. 2023</span>
            </span><br>
